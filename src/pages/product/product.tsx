...
const Product = (): JSX.Element => {
  ...
  const {name, previewImg, previewImg2x, previewImgWebp, previewImgWebp2x, price, rating, reviewCount} = data;
  const similarData = useAppSelector((state) => state.similarProductList);
